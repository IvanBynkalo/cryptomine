...
const HULLS_CATALOG = [
  // T1 — Лёгкие (lvl 1-5)
  { id:'hull_swift_m',    name:'Стремительный-М',        cat:'hull', subcat:'light',   tier:1, rarity:'common',
  ...
  { id:'hull_ranger_one', name:'Рейнджер-1',     cat:'hull', subcat:'universal',tier:1,rarity:'common',
    mfr:'RangerCore',   role:'Универсал',  levelRequired:1,  price:200,    upkeep:5,
  ...
  { id:'hull_mule_t1',    name:'Мул Т-1',       cat:'hull', subcat:'cargo',   tier:1, rarity:'common',
    mfr:'CargoMax',     role:'Торговля',   levelRequired:3,  price:500,   upkeep:8,
  ...
  { id:'hull_interceptor', name:'Перехватчик-Х', cat:'hull', subcat:'light',   tier:2, rarity:'enhanced',
    mfr:'RangerCore',   role:'Перехват',   levelRequired:6,  price:2000,   upkeep:15,
  ...
  { id:'hull_scout_pro',   name:'Скаут Про',     cat:'hull', subcat:'explorer', tier:2,rarity:'enhanced',
    mfr:'SigmaLab',     role:'Разведка',   levelRequired:7,  price:2500,   upkeep:18,
  ...
  { id:'hull_atlas_cargo', name:'Атлас Карго',   cat:'hull', subcat:'cargo',   tier:2, rarity:'enhanced',
    mfr:'CargoMax',     role:'Торговля',   levelRequired:8,  price:3500,   upkeep:20,
  ...
  { id:'hull_fighter_mk2', name:'Истребитель МК-2', cat:'hull', subcat:'combat',  tier:2, rarity:'enhanced',
    mfr:'BastionWorks', role:'Бой',        levelRequired:9,  price:4000,   upkeep:25,
  ...
  { id:'hull_cruiser_r',   name:'Крейсер Рейнджер', cat:'hull', subcat:'universal',tier:3,rarity:'rare',
    mfr:'RangerCore',   role:'Универсал',  levelRequired:11, price:10000,  upkeep:45,
  ...
  { id:'hull_bastion_x',   name:'Бастион-Х',     cat:'hull', subcat:'combat',  tier:3, rarity:'rare',
    mfr:'BastionWorks', role:'Осада',      levelRequired:13, price:15000,  upkeep:65,
  ...
  { id:'hull_horizon',     name:'Горизонт Глубин',  cat:'hull', subcat:'explorer', tier:3,rarity:'rare',
    mfr:'SigmaLab',     role:'Наука',      levelRequired:14, price:12000,  upkeep:55,
  ...
  { id:'hull_freighter',   name:'Фрейтер Про', cat:'hull', subcat:'cargo',   tier:3, rarity:'rare',
    mfr:'CargoMax',     role:'Логистика',  levelRequired:15, price:18000,  upkeep:60,
  ...
  { id:'hull_carrier',     name:'Звёздный Маршал',  cat:'hull', subcat:'command', tier:4, rarity:'military',
    mfr:'CivicUnion',   role:'Командование',levelRequired:20, price:40000, upkeep:150,
  ...
  { id:'hull_warlord',     name:'Варлорд-IV',    cat:'hull', subcat:'combat',  tier:4, rarity:'military',
    mfr:'BastionWorks', role:'Линкор',     levelRequired:22, rankRequired:'Мастер', price:60000, upkeep:220,
  ...
  { id:'hull_market_king', name:'Король Торговли',   cat:'hull', subcat:'cargo',   tier:4, rarity:'military',
    mfr:'CargoMax',     role:'Торговля',   levelRequired:25, price:50000, upkeep:350,
  ...
  { id:'hull_dread',       name:'Дредноут',   cat:'hull', subcat:'combat',  tier:5, rarity:'experimental',
    mfr:'BastionWorks',  role:'Дредноут',  levelRequired:30, rankRequired:'Легенда', price:200000, upkeep:700,
  ...
  { id:'hull_sigma_prime', name:'Сигма Прайм',   cat:'hull', subcat:'explorer', tier:5,rarity:'experimental',
    mfr:'SigmaLab',      role:'ЭкспНаука', levelRequired:32, price:150000, upkeep:500,
  ...
  { id:'hull_void_x',      name:'Пустота-Х',        cat:'hull', subcat:'experimental',tier:6,rarity:'legendary',
    mfr:'XenoTech',      role:'Пустота',    levelRequired:42, bossKillRequired:3, price:800000, upkeep:2500,
  ...
  { id:'hull_xenoform',    name:'КсеноФорма',     cat:'hull', subcat:'experimental',tier:6,rarity:'legendary',
    mfr:'XenoTech',      role:'КсеноФорма', levelRequired:45, bossKillRequired:5, price:1200000, upkeep:4000,
  ...
  { id:'hull_patrol',      name:'Патруль-7',      cat:'hull', subcat:'light',   tier:2, rarity:'enhanced',
    mfr:'RangerCore',   role:'Патруль',    levelRequired:5,  price:4000,   upkeep:12,
  ...
  { id:'hull_commando',    name:'Коммандо',      cat:'hull', subcat:'combat',  tier:3, rarity:'rare',
    mfr:'BastionWorks', role:'Штурм',      levelRequired:16, price:20000,  upkeep:80,
  ...
  { id:'hull_diplomat',    name:'Дипломат',   cat:'hull', subcat:'command', tier:3, rarity:'rare',
    mfr:'CivicUnion',   role:'Дипломатия', levelRequired:18, price:22000,  upkeep:180,
  ...
  { id:'hull_salvager',    name:'Утилизатор',      cat:'hull', subcat:'cargo',   tier:2, rarity:'enhanced',
    mfr:'CargoMax',     role:'Утилизация', levelRequired:10, price:5000,  upkeep:60,
  ...
  { id:'hull_ghost',       name:'Призрак',  cat:'hull', subcat:'light',   tier:4, rarity:'military',
    mfr:'RangerCore',   role:'Стелс',      levelRequired:28, price:70000, upkeep:260,
  ...
  { id:'hull_fortress',    name:'Крепость',      cat:'hull', subcat:'combat',  tier:5, rarity:'experimental',
    mfr:'BastionWorks', role:'Крепость',   levelRequired:38, rankRequired:'Призрак', price:300000, upkeep:1000,
...
const WEAPONS_CATALOG = [
  // Лазеры T1
  { id:'wpn_beam1',       name:'Луч-1',         cat:'weapon', subcat:'laser',  tier:1, rarity:'common',
    mfr:'HeliosArms',  levelRequired:1,  price:0,     stats:{atk:5,  energy:0}, icon:'🔴', desc:'Стартовый лазер.' },
  { id:'wpn_beam2',       name:'Луч-2',         cat:'weapon', subcat:'laser',  tier:2, rarity:'enhanced',
    mfr:'HeliosArms',  levelRequired:4,  price:2000,  stats:{atk:12, energy:1}, icon:'🔴', desc:'Улучшенный лазер +12 урона.' },
  { id:'wpn_helios3',     name:'Гелиос III',     cat:'weapon', subcat:'laser',  tier:3, rarity:'rare',
    mfr:'HeliosArms',  levelRequired:10, price:5000, stats:{atk:25, energy:2, crit:.08}, icon:'🔴', desc:'Профлазер. Крит 8%.' },
  { id:'wpn_sunstrike',   name:'Солнечный Удар',     cat:'weapon', subcat:'laser',  tier:4, rarity:'military',
    mfr:'HeliosArms',  levelRequired:20, price:60000, stats:{atk:55, energy:3, crit:.15}, icon:'☀️', desc:'Военный лазер. Крит 15%.' },
  { id:'wpn_sol_cannon',  name:'Пушка Сол',     cat:'weapon', subcat:'laser',  tier:5, rarity:'experimental',
  ...
  { id:'wpn_photon_god',  name:'Фотонный Бог',     cat:'weapon', subcat:'laser',  tier:6, rarity:'legendary',
  ...
  // Баллистика T1-T6
  { id:'wpn_iron_burst',  name:'Железный Залп',     cat:'weapon', subcat:'ballistic',tier:1,rarity:'common',
    mfr:'BastionWorks',levelRequired:2,  price:800,   stats:{atk:8,  piercing:.1}, icon:'💥', desc:'Пробивает броню 10%.' },
  { id:'wpn_gatling',     name:'Гатлинг-22',     cat:'weapon', subcat:'ballistic',tier:2,rarity:'enhanced',
    mfr:'BastionWorks',levelRequired:6,  price:4000,  stats:{atk:18, piercing:.15, multiHit:2}, icon:'🔫', desc:'Двойной выстрел.' },
  { id:'wpn_rail_fang',   name:'Рейл-Клык',      cat:'weapon', subcat:'railgun',  tier:3,rarity:'rare',
    mfr:'BastionWorks',levelRequired:12, price:18000, stats:{atk:40, piercing:.3,  armor_break:.2}, icon:'⚡', desc:'Пробивает щиты 30%.' },
  { id:'wpn_mass_driver', name:'Масс-Драйвер',    cat:'weapon', subcat:'railgun',  tier:4,rarity:'military',
  ...
  { id:'wpn_void_slug',   name:'Пуля Пустоты',      cat:'weapon', subcat:'railgun',  tier:5,rarity:'experimental',
    mfr:'XenoTech',    levelRequired:33, price:300000,stats:{atk:160,piercing:.55,critMod:.25}, icon:'🌑', desc:'Пуля из материи пустоты.' },

  // Ракеты
  { id:'wpn_hydra2',      name:'Гидра-2',        cat:'weapon', subcat:'missile',  tier:2,rarity:'enhanced',
  ...
  { id:'wpn_omega_torp',  name:'Omega Torpedo',  cat:'weapon', subcat:'missile',  tier:5,rarity:'experimental',
    mfr:'XenoTech',    levelRequired:35, price:150000,stats:{missileDmg:500,missiles:6,aoe:.5,shieldBreak:.4}, icon:'☢️', desc:'Ломает щиты 40%.' },
  ...
  { id:'wpn_sun_plasma',  name:'Solar Annihilator',cat:'weapon',subcat:'plasma',  tier:5,rarity:'experimental',
    mfr:'HeliosArms',  levelRequired:36, price:200000,stats:{atk:140,burnChance:.7,burnDmg:35}, icon:'☀️', desc:'Почти всегда поджигает. Легко уничтожает.' },
  ...
  { id:'wpn_mind_rift',   name:'Mind Rift',       cat:'weapon', subcat:'xenotech', tier:6,rarity:'legendary',
    mfr:'XenoTech',    levelRequired:43, bossKillRequired:3, price:800000, stats:{atk:200,psiPierce:.6,crit:.35}, icon:'🌀', desc:'Пробивает пси-защиту 60%.' },

  // Дополнительные (до 54)
  { id:'wpn_scatter',     name:'Шрапнель',   cat:'weapon', subcat:'ballistic',tier:2,rarity:'enhanced',
    mfr:'BastionWorks',levelRequired:7,  price:2000,  stats:{atk:15, multiHit:3, atkPenalty:.2}, icon:'💢', desc:'3 попадания -20% каждое.' },
  { id:'wpn_sniper',      name:'Дальний Глаз',        cat:'weapon', subcat:'laser',   tier:3,rarity:'rare',
    mfr:'HeliosArms',  levelRequired:14, price:22000, stats:{atk:60, crit:.2, atkPenalty:.1}, icon:'🎯', desc:'Снайперский лазер. Крит 20%.' },
  { id:'wpn_emp',         name:'ЭМИ-Бластер',    cat:'weapon', subcat:'special',  tier:3,rarity:'rare',
    mfr:'SigmaLab',    levelRequired:15, price:10000, stats:{atk:20, energyDrain:15, shieldDisable:.3}, icon:'⚡', desc:'Высасывает 15 энергии, 30% отключить щит.' },
  { id:'wpn_grav_cannon', name:'Грав-Пушка',    cat:'weapon', subcat:'special',  tier:4,rarity:'military',
    mfr:'XenoTech',    levelRequired:25, price:110000,stats:{atk:65, slowEffect:.4, piercing:.25}, icon:'🌀', desc:'Замедляет врага 40%.' },
  { id:'wpn_ion_storm',   name:'Ионный Шторм',      cat:'weapon', subcat:'plasma',   tier:4,rarity:'military',
    mfr:'HeliosArms',  levelRequired:24, price:95000, stats:{atk:80, ionChain:.25, chainDmg:.5}, icon:'⚡', desc:'Цепная молния 25% шанс.' },
  { id:'wpn_twin_laser',  name:'Двойная Спираль',     cat:'weapon', subcat:'laser',    tier:3,rarity:'rare',
    mfr:'HeliosArms',  levelRequired:12, price:16000, stats:{atk:20, multiHit:2}, icon:'🔴', desc:'Двойной лазерный удар.' },
  { id:'wpn_auto_rail',   name:'Авторейл',      cat:'weapon', subcat:'railgun',  tier:3,rarity:'rare',
    mfr:'BastionWorks',levelRequired:13, price:19000, stats:{atk:35, multiHit:2, piercing:.2}, icon:'⚙️', desc:'Авторельсотрон. 2 снаряда.' },
  { id:'wpn_cluster',     name:'Кассетная Бомба',   cat:'weapon', subcat:'missile',  tier:3,rarity:'rare',
    mfr:'RangerCore',  levelRequired:12, price:17000, stats:{missileDmg:90, missiles:2, aoe:.2}, icon:'💣', desc:'Кассетная бомба.' },
  { id:'wpn_disruptor',   name:'Дезориентатор',      cat:'weapon', subcat:'special',  tier:4,rarity:'military',
    mfr:'XenoTech',    levelRequired:26, price:50000,stats:{atk:50, specialDisrupt:.5, critVsDisrupted:.5}, icon:'🔮', desc:'Дезориентирует цель. Крит ×2 по дезор.' },
  { id:'wpn_dark_matter', name:'Пушка Тёмной Материи',cat:'weapon', subcat:'xenotech', tier:5,rarity:'experimental',
...
const SHIELDS_CATALOG = [
  ...
  { id:'def_nullfield',    name:'Нуль-Поле',    cat:'defense', subcat:'shield', tier:4,rarity:'military',
...
const ENGINES_CATALOG = [
  { id:'eng_ecodrive1',   name:'ЭкоДрайв-1',     cat:'engine', subcat:'economy',tier:1,rarity:'common',
    mfr:'NovaDrive',   levelRequired:1,  price:0,     stats:{fuelMod:0, speed:1}, icon:'🔥', desc:'Стандартный двигатель.' },
  { id:'eng_razor',       name:'Острый Форсаж',     cat:'engine', subcat:'speed',  tier:2,rarity:'enhanced',
    mfr:'NovaDrive',   levelRequired:4,  price:2500,  stats:{fuelMod:-.1, speed:1.2}, icon:'⚡', desc:'Скоростной. -10% топлива.' },
  { id:'eng_longSail',    name:'Дальний Ход',      cat:'engine', subcat:'range',  tier:2,rarity:'enhanced',
    mfr:'NovaDrive',   levelRequired:6,  price:3500,  stats:{fuelMod:-.25, maxFuel:20}, icon:'🚀', desc:'Дальний. -25% топлива, +20 бак.' },
  { id:'eng_vector_core', name:'Векторное Ядро',    cat:'engine', subcat:'tactical',tier:3,rarity:'rare',
    mfr:'NovaDrive',   levelRequired:11, price:5000, stats:{fuelMod:-.3, dodge:.04}, icon:'🌀', desc:'Тактический. Уклонение +4%.' },
  { id:'eng_warp_drive',  name:'Варп-Привод',     cat:'engine', subcat:'warp',   tier:3,rarity:'rare',
    mfr:'NovaDrive',   levelRequired:13, price:20000, stats:{fuelMod:-.35, warp:true}, icon:'🌌', desc:'Открывает новые галактики.' },
  { id:'eng_quantum_leap',name:'Квантовый Прыжок',   cat:'engine', subcat:'warp',   tier:4,rarity:'military',
    mfr:'NovaDrive',   levelRequired:22, price:80000, stats:{fuelMod:-.55, instantTravel:true}, icon:'✨', desc:'Мгновенный перелёт.' },
  { id:'eng_zero_rift',   name:'Нулевой Разлом',      cat:'engine', subcat:'experimental',tier:5,rarity:'experimental',
    mfr:'XenoTech',    levelRequired:35, price:200000,stats:{fuelMod:-.75, fuelFree:true}, icon:'♾️', desc:'Бесплатные перелёты. Открывает Омегу.' },
  // Дополнительные до 24
...
const SPECMODS_CATALOG = [
  ...
  { id:'mod_xeno_scanner',name:'Ксено-Сканер',   cat:'specmod', subcat:'science',tier:4,rarity:'military',
  ...
  { id:'mod_trade_lord',  name:'Лорд Торговли',     cat:'specmod', subcat:'trade',  tier:5,rarity:'experimental',
...
const DRONES_CATALOG = [
  { id:'drone_sting',     name:'Дрон-Жало',    cat:'support', subcat:'combat', tier:2,rarity:'enhanced',
    mfr:'RangerCore',  levelRequired:5,  price:4000,  stats:{droneDmg:15, droneCount:1}, icon:'🤖', desc:'Боевой дрон. +15 урона.' },
  { id:'drone_patch',     name:'Дрон-Латка',    cat:'support', subcat:'repair', tier:2,rarity:'enhanced',
    mfr:'SigmaLab',    levelRequired:6,  price:4500,  stats:{droneRegen:5, droneCount:1}, icon:'🔧', desc:'Ремонтный дрон. +5 ХП/сек.' },
  { id:'drone_mule',      name:'Бот-Мул',       cat:'support', subcat:'cargo',  tier:2,rarity:'enhanced',
    mfr:'CargoMax',    levelRequired:5,  price:3500,  stats:{cargo:10, autoCollect:true}, icon:'🚁', desc:'Грузовой дрон. +10 трюма, автосбор.' },
  { id:'drone_probe_x',   name:'Зонд-Х',        cat:'support', subcat:'scout',  tier:3,rarity:'rare',
    mfr:'SigmaLab',    levelRequired:10, price:5000, stats:{sciMod:.1, anomalyChance:.15, droneCount:1}, icon:'🔭', desc:'Разведывательный зонд. Аномалии +15%.' },
  { id:'drone_marshal',   name:'Командный Линк',   cat:'support', subcat:'command',tier:4,rarity:'military',
  ...
  { id:'drone_guardian',  name:'Бот-Страж',   cat:'support', subcat:'combat', tier:4,rarity:'military',
  ...
  { id:'drone_medpod',    name:'Медкапсула Альфа',  cat:'support', subcat:'repair', tier:3,rarity:'rare',
  ...
  { id:'drone_xeno_link', name:'Ксено-Линк',      cat:'support', subcat:'command',tier:5,rarity:'experimental',
